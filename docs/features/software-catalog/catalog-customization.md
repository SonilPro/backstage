...
You can configure the context menu items using `EntityContextMenuItemBlueprint`. The current items are defined [here](https://github.com/backstage/backstage/blob/5d0d2c547c7a67a60c4097334bd2c2ca11fbd6b3/plugins/catalog/src/alpha/contextMenuItems.tsx#L54)
